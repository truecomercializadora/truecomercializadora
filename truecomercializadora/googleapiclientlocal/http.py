...
import uuid
import sys
sys.path.append("./googleapiclientlocal")
import httplib2
    ...
    def __init__(self, fd, request, chunksize=DEFAULT_CHUNK_SIZE):
        ...
        Args:
          fd: io.Base or file object, The stream in which to write the downloaded
            bytes.
          request: googleapiclientlocal.http.HttpRequest, the media request to perform in
            chunks.
...
class BatchHttpRequest(object):
    ...
    Example:
      from googleapiclientlocal.http import BatchHttpRequest
