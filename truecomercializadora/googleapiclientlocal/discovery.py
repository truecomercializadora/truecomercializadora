...
# Local imports
from googleapiclientlocal import _auth, mimeparse
from googleapiclientlocal._helpers import _add_query_parameter, positional
from googleapiclientlocal.errors import (
    HttpError,
    InvalidJsonError,
...
from googleapiclientlocal.http import (
    BatchHttpRequest,
    HttpMock,
    HttpMockSequence,
    HttpRequest,
...
from googleapiclientlocal.model import JsonModel, MediaModel, RawModel
from googleapiclientlocal.schema import Schemas
...
def build(
    ...
    Args:
      ...
      model: googleapiclientlocal.Model, converts to and from the wire format.
